...
public class Main {
    public static void main(String[] args) {
        ...
        //CREO LA BACHECA
        MyDataBoard<Data> Bacheca=null;
        try{
            Bacheca=new MyDataBoard<>(P1);
            //Bacheca=new MyDataBoard<>(P3); //NullPointerException,P3==null
        }
        ...
        try {
            ...
            // Bacheca.addFriend(C3, P1, A3);//NoCategoryException
        ...
        try {
            ...
            // Bacheca.removeFriend(C3, P1, A1);// NoCategoryException
        ...
        try {
            ...
            // Bacheca.put(P1, post1, C3);// NoCategoryException
        ...
        try {
            ...
            System.out.println("");
            //Bacheca.getDataCategory(P1, C3);// NoCategoryException
        ...
        } catch (NullPointerException | DataNotFoundException | PermissionDeniedException | NoCategoryException e) {
            System.out.println(e);
        }
        ...
        try {
            ...
            // Bacheca.getFriendIterator(A5);// NoOneCategoryException
