...
public interface DataBoard<E extends Data> {
        ...
        /**
         * Typical Element:<Password,Category,ListaAmici,ListaDati> dove:
         *                  Password e` la chiave di accesso del proprietario della bacheca
         ...
         *          dato fa parte lancia l'eccezione PermessissionDeniedException(CHECKED)
         * @Modifies:this
